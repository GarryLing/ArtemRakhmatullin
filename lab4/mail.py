...
db = psycopg2.connect("dbname=db user=postgres password=1508 host=127.0.0.1 port=5432")
...
if __name__ == "__main__":
    try:
        ...
        # myMail = Mail()
        # myMail.from_ = EmailField("sophia2@test.ru")
        # myMail.to = EmailField("sophia@test.ru")
        # myMail.theme = ThemeField("hello")
        # myMail.message = MessageField("meow")
        # myMail.save()
